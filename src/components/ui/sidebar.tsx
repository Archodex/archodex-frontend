      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            // Archodex:
            // * Set width (v4 ny shadcn SheetContent also sets w-3/4)
            // * Set z-index so it's visually under the Resume Tutorial button
            className="z-30 w-(--sidebar-width)! max-w-full bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
